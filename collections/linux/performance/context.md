...
不要忘了，硬件通过触发信号，会导致中断处理程序的调用，

也是一种常见的任务。所以，根据任务的不同，CPU 的上下文切换就可以分为几个不同的场景，也就是
...
分别对应着下图中， CPU 特权等级的 Ring 0 和 Ring 3。
...
![image-20220428125817614](/Users/user/playground/share/nrookie.github.io/collections/linux/performance/image-20220428125817614.png)
...
![image-20220428130045804](/Users/user/playground/share/nrookie.github.io/collections/linux/performance/image-20220428130045804.png)
...
其三，当进程通过睡眠函数 sleep 这样的方法将自己主动挂起时，自然也会重新调度。其
