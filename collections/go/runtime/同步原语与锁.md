...
![image-20220317103713622](/Users/user/playground/share/nrookie.github.io/collections/go/runtime/image-20220317103713622.png)
...
#### 状态 [#](https://draveness.me/golang/docs/part3-runtime/ch06-concurrency/golang-sync-primitives/#状态)

互斥锁的状态比较复杂，如下图所示，最低三位分别表示 `mutexLocked`、`mutexWoken` 和 `mutexStarving`，剩下的位置用来表示当前有多少个 Goroutine 在等待互斥锁的释放：



![image-20220317103837266](/Users/user/playground/share/nrookie.github.io/collections/go/runtime/image-20220317103837266.png)
...
#### 正常模式和饥饿模式 [#](https://draveness.me/golang/docs/part3-runtime/ch06-concurrency/golang-sync-primitives/#正常模式和饥饿模式)
...
![image-20220317104406991](/Users/user/playground/share/nrookie.github.io/collections/go/runtime/image-20220317104406991.png)
...
#### 加锁和解锁 [#](https://draveness.me/golang/docs/part3-runtime/ch06-concurrency/golang-sync-primitives/#加锁和解锁)
...
### RWMutex [#](https://draveness.me/golang/docs/part3-runtime/ch06-concurrency/golang-sync-primitives/#rwmutex)
...
#### 写锁 [#](https://draveness.me/golang/docs/part3-runtime/ch06-concurrency/golang-sync-primitives/#写锁)
...
1. 调用结构体持有的sync.Mutex 结构体的`sync.Mutex.Lock`
...
#### 读锁 [#](https://draveness.me/golang/docs/part3-runtime/ch06-concurrency/golang-sync-primitives/#读锁)
...
#### 小结 [#](https://draveness.me/golang/docs/part3-runtime/ch06-concurrency/golang-sync-primitives/#小结-1)
...
![image-20220317113629429](/Users/user/playground/share/nrookie.github.io/collections/go/runtime/image-20220317113629429.png)
...
![image-20220317113811214](/Users/user/playground/share/nrookie.github.io/collections/go/runtime/image-20220317113811214.png)
...
#### 接口 [#](https://draveness.me/golang/docs/part3-runtime/ch06-concurrency/golang-sync-primitives/#接口)
...
#### 小结 [#](https://draveness.me/golang/docs/part3-runtime/ch06-concurrency/golang-sync-primitives/#小结-2)
...
## Cond [#](https://draveness.me/golang/docs/part3-runtime/ch06-concurrency/golang-sync-primitives/#cond)
...
![image-20220317115059877](/Users/user/playground/share/nrookie.github.io/collections/go/runtime/image-20220317115059877.png)
...
![image-20220317115535085](/Users/user/playground/share/nrookie.github.io/collections/go/runtime/image-20220317115535085.png)
...
#### 小结 [#](https://draveness.me/golang/docs/part3-runtime/ch06-concurrency/golang-sync-primitives/#小结-4)
...
## 6.2.2 扩展原语 [#](https://draveness.me/golang/docs/part3-runtime/ch06-concurrency/golang-sync-primitives/#622-扩展原语)

除了标准库中提供的同步原语之外，Go 语言还在子仓库 [sync](https://github.com/golang/sync) 中提供了四种扩展原语，[`golang/sync/errgroup.Group`](https://draveness.me/golang/tree/golang/sync/errgroup.Group)、[`golang/sync/semaphore.Weighted`](https://draveness.me/golang/tree/golang/sync/semaphore.Weighted)、[`golang/sync/singleflight.Group`](https://draveness.me/golang/tree/golang/sync/singleflight.Group) 和 [`golang/sync/syncmap.Map`](https://draveness.me/golang/tree/golang/sync/syncmap.Map)，其中的 [`golang/sync/syncmap.Map`](https://draveness.me/golang/tree/golang/sync/syncmap.Map) 在 1.9 版本中被移植到了标准库中[2](https://draveness.me/golang/docs/part3-runtime/ch06-concurrency/golang-sync-primitives/#fn:2)。



![image-20220317120339519](/Users/user/playground/share/nrookie.github.io/collections/go/runtime/image-20220317120339519.png)
...
### ErrGroup [#](https://draveness.me/golang/docs/part3-runtime/ch06-concurrency/golang-sync-primitives/#errgroup)
...
#### 结构体 [#](https://draveness.me/golang/docs/part3-runtime/ch06-concurrency/golang-sync-primitives/#结构体-4)
...
#### 接口 [#](https://draveness.me/golang/docs/part3-runtime/ch06-concurrency/golang-sync-primitives/#接口-3)
...
### Semaphore [#](https://draveness.me/golang/docs/part3-runtime/ch06-concurrency/golang-sync-primitives/#semaphore)
...
#### 结构体 [#](https://draveness.me/golang/docs/part3-runtime/ch06-concurrency/golang-sync-primitives/#结构体-5)
...
![image-20220317121059545](/Users/user/playground/share/nrookie.github.io/collections/go/runtime/image-20220317121059545.png)



信号量中的计数器会随着用户对资源的访问和释放进行改变，引入的权重概念能够提供更细粒度的资源的访问控制，尽可能满足常见的用例。

#### 获取 [#](https://draveness.me/golang/docs/part3-runtime/ch06-concurrency/golang-sync-primitives/#获取)
...
#### 释放 [#](https://draveness.me/golang/docs/part3-runtime/ch06-concurrency/golang-sync-primitives/#释放)
...
#### 小结 [#](https://draveness.me/golang/docs/part3-runtime/ch06-concurrency/golang-sync-primitives/#小结-6)
...
### SingleFlight [#](https://draveness.me/golang/docs/part3-runtime/ch06-concurrency/golang-sync-primitives/#singleflight)
...
![image-20220317121738537](/Users/user/playground/share/nrookie.github.io/collections/go/runtime/image-20220317121738537.png)
...
![image-20220317121805562](/Users/user/playground/share/nrookie.github.io/collections/go/runtime/image-20220317121805562.png)
...
#### 结构体 [#](https://draveness.me/golang/docs/part3-runtime/ch06-concurrency/golang-sync-primitives/#结构体-6)
...
#### 接口 [#](https://draveness.me/golang/docs/part3-runtime/ch06-concurrency/golang-sync-primitives/#接口-4)
...
#### 小结 [#](https://draveness.me/golang/docs/part3-runtime/ch06-concurrency/golang-sync-primitives/#小结-7)
...
## 6.2.3 小结 [#](https://draveness.me/golang/docs/part3-runtime/ch06-concurrency/golang-sync-primitives/#623-小结)
