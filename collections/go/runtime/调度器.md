# 6.5 调度器 [#](https://draveness.me/golang/docs/part3-runtime/ch06-concurrency/golang-goroutine/#65-调度器)
...
![image-20220317212917665](/Users/user/playground/share/nrookie.github.io/collections/go/runtime/image-20220317212917665.png)
...
![image-20220317213240867](/Users/user/playground/share/nrookie.github.io/collections/go/runtime/image-20220317213240867.png)
...
## 6.5.1 设计原理 [#](https://draveness.me/golang/docs/part3-runtime/ch06-concurrency/golang-goroutine/#651-设计原理)
...
### 单线程调度器 [#](https://draveness.me/golang/docs/part3-runtime/ch06-concurrency/golang-goroutine/#单线程调度器)
...
![image-20220317220757487](/Users/user/playground/share/nrookie.github.io/collections/go/runtime/image-20220317220757487.png)
...
![image-20220317224234842](/Users/user/playground/share/nrookie.github.io/collections/go/runtime/image-20220317224234842.png)
...
o 语言的调度器在最初的几个版本中迅速迭代，但是从 1.2 版本之后调度器就没有太多的变化，直到 1.14 版本引入了真正的抢占式调度才解决了自 1.2 以来一直存在的问题。在可预见的未来，Go 语言的调度器还会进一步演进，增加触发抢占式调度的时间点以减少存在的边缘情况。
...
![image-20220317224622890](/Users/user/playground/share/nrookie.github.io/collections/go/runtime/image-20220317224622890.png)
...
![image-20220317225913332](/Users/user/playground/share/nrookie.github.io/collections/go/runtime/image-20220317225913332.png)
...
![image-20220317230000571](/Users/user/playground/share/nrookie.github.io/collections/go/runtime/image-20220317230000571.png)
...
![image-20220317230134739](/Users/user/playground/share/nrookie.github.io/collections/go/runtime/image-20220317230134739.png)
...
![image-20220317230229336](/Users/user/playground/share/nrookie.github.io/collections/go/runtime/image-20220317230229336.png)
...
![image-20220318110104905](/Users/user/playground/share/nrookie.github.io/collections/go/runtime/image-20220318110104905.png)
...
![image-20220318110958758](/Users/user/playground/share/nrookie.github.io/collections/go/runtime/image-20220318110958758.png)
...
![image-20220318111719755](/Users/user/playground/share/nrookie.github.io/collections/go/runtime/image-20220318111719755.png)
...
![image-20220318111920731](/Users/user/playground/share/nrookie.github.io/collections/go/runtime/image-20220318111920731.png)
...
![image-20220318112001240](/Users/user/playground/share/nrookie.github.io/collections/go/runtime/image-20220318112001240.png)
...
![image-20220318112620219](/Users/user/playground/share/nrookie.github.io/collections/go/runtime/image-20220318112620219.png)
